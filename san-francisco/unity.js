! function(n) {
    ...
    var i = {
        ...
        maxRatio: 16 / 9,
        minRatio: 9 / 16,
        thumbnail: "https://www.getgames.io/games/si2u1899susjao11/s91a2n12fr0an29121/screenshots/sanfr.jpg",
        numScreenshots: 4,
    ...
    var m, p, g, w, v, y, b = t(10),
        ...
        T = window.location.hostname.endsWith("") || window.location.hostname.endsWith(""),
        B = T ? "".concat(C, "/") : "";
